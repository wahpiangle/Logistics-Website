...
export default function Home() {
    return (
        <>
            ...
            <div className="bg-secondary flex items-center px-28 py-14 gap-10">
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-8">
                    <div className="flex gap-8">
                        <div>
                            <img src={iconShip} className="object-contain w-20 h-auto" />
                        </div>
                    ...
                    <div className="flex gap-8">
                        <div>
                            <img src={iconBuilding} className="object-contain w-20 h-auto" />
                        </div>
                        <div className="border-l-2 px-4">
                    ...
                    <div className="flex gap-8">
                        <div>
                            <img src={iconPlane} className="object-contain w-20 h-auto" />
                        </div>
                        <div className="border-l-2 px-4">
                    ...
                    <div className="flex gap-8">
                        <div>
                            <img src={iconLorry} className="object-contain w-20 h-auto" />
                        </div>
                        <div className="border-l-2 px-4">
            ...
            <img src={cargoBox} />
            <div className="relative z-10 flex gap-10 justify-around px-12 mx-48 py-12 -mt-24 bg-fixed bg-white">
                <div className="">
                    ...
                    <p className="text-paragraph text-[14px]">Leverage agile frameworks to provide a robust synopsis for strategy foster collaborative thinking to further the overall value proposition. <br/><br/>Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment.</p>
